...
export default class BookRequestScreen extends Component {
  ...
  addRequest = async (bookName, reasonToRequest) => {
    ...
    return Alert.alert("Request Requested Successfully");
  };
            ...
            .then((snapshot) => {
              snapshot.forEach((doc) => {
                ...
                db.collection("all_notifications").add({
                  ...
                  message:
                    name + " " + lastName + " reported you. you have a warning" + bookName,
    ...
    if (this.state.IsBookRequestActive === true) {
      return (
        <View style={{ flex: 1}}>
          ...
          >
            <MyHeader title="report" navigation={this.props.navigation} />
          </View>
          <View
          ...
          {this.state.showFlatlist ? (
            ...
            <View style={{ alignItems: "center" }}>
              <Input
                ...
                numberOfLines={8}
                label={"Reason"}
                placeholder={"Why do you want to report this person"}
                onChangeText={(text) => {
                  this.setState({
